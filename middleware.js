...
const TIER1_TEAMS_SSR = [
  ...
  { id: 'tundra-esports', name: 'Tundra Esports', region: 'WEU', disbanded: true, basedIn: 'United Kingdom', tiWins: [2022], shortDesc: 'The International 2022 champions. Exited competitive Dota 2 in June 2026, with their entire roster transferring to what is now Iron Wing.', liquipedia: 'https://liquipedia.net/dota2/Tundra_Esports' },
  // 2026-08-01: org renamed "1win" -> "1w Team" (owner-confirmed). 2026-08-10: owner-confirmed a
  // further rebrand, "1w Team" -> "Iron Wing" — id/liquipedia URL left unchanged, see src/data/teams.js.
  { id: '1win', name: 'Iron Wing', region: 'EEU', basedIn: 'Russia', tiWins: [], shortDesc: 'Russian Dota 2 organization (formerly branded 1win, then 1w Team) that signed the full Tundra Esports roster in June 2026, inheriting their TI 2026 direct invite.', liquipedia: 'https://liquipedia.net/dota2/1win_Team' },
...
const TIER1_NAME_PATTERNS_SSR = [
  ...
  'EPL Masters', 'Games of the Future',
]
