          ...
          <div className="flex flex-col gap-6">
            ...
            {nextMatchId && (
              <button
                ...
                className="focus-ring py-3 text-sm font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border border-gray-200 dark:border-gray-800 rounded transition-colors disabled:opacity-50"
              >
