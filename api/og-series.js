                  ...
                  props: {
                    ...
                    children: [
                      tournament ? {
                        type: 'span',
                        props: {
                          style: { fontSize: '13px', color: '#6b7280', letterSpacing: '0.15em', textTransform: 'uppercase', fontWeight: 600 },
                          children: tournament
                        }
                      } : null,
                      {
                        ...
                        props: {
                          ...
                          children: [
                            ...
                            },
                            {
                              type: 'span',
                              props: {
                                style: { fontSize: '11px', color: '#6b7280', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600 },
                                children: 'SERIES RESULT'
                              }
                            }
                          ]
                        }
                  ...
                  props: {
                    ...
                    children: [
                      // Winner side
                      {
                        type: 'div',
                        props: {
                          style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '6px', flex: 1 },
                          children: [
                            {
                              type: 'span',
                              props: {
                                style: { fontSize: '11px', fontWeight: 700, letterSpacing: '0.25em', textTransform: 'uppercase', color: '#ef4444' },
                                children: 'WINNER'
                              }
                            },
                            {
                              type: 'span',
                              props: {
                                style: { fontSize: `${winnerFontSize}px`, fontWeight: 900, textTransform: 'uppercase', color: '#ffffff', lineHeight: 1 },
                                children: winner
                              }
                            }
                          ]
                                ...
                                children: [
                                  {
                                    type: 'span',
                                    props: {
                                      style: { fontSize: '88px', fontWeight: 900, color: '#ffffff', lineHeight: 1 },
                                      children: String(isNaN(winnerGames) ? score.split('-')[0] : winnerGames)
                                    }
                                  },
                                  {
                                    type: 'span',
                                    props: {
                                      style: { fontSize: '40px', fontWeight: 300, color: '#374151', lineHeight: 1 },
                                      children: '-'
                                    }
                                  },
                                  {
                                    type: 'span',
                                    props: {
                                      style: { fontSize: '88px', fontWeight: 900, color: '#374151', lineHeight: 1 },
                                      children: String(isNaN(loserGames) ? score.split('-')[1] : loserGames)
                                    }
                                  },
                                ]
                              }
                      ...
                      // Loser side
                      {
                        type: 'div',
                        props: {
                          style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px', flex: 1 },
                          children: [
                            {
                              type: 'span',
                              props: {
                                style: { fontSize: '11px', color: 'transparent' },
                                children: '.'
                              }
                            },
                            {
                              type: 'span',
                              props: {
                                style: { fontSize: `${loserFontSize}px`, fontWeight: 900, textTransform: 'uppercase', color: '#4b5563', lineHeight: 1, textAlign: 'right' },
                                children: loser
                              }
                            }
                          ]
