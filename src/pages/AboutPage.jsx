        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Series Grouping", desc: "Games are grouped into BO1, BO3, and BO5 series with series scores. Expand a card to see a G1/G2/G3 switcher — the active game highlights as you switch. Click any chip or game row to open it in the drawer." },
