        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Series Grouping", desc: "Games are grouped into BO1, BO3, and BO5 series with series scores. Click a result to open the series, then switch between games using the G1 / G2 / G3 tabs inside the drawer — no closing and re-clicking." },
