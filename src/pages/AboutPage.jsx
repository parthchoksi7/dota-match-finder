        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Tournament Hub", desc: "Always-visible section on the homepage showing live and upcoming tournaments. When multiple tournaments are running at once, they collapse into a single count pill - click to expand and navigate directly to any event. Includes full standings, schedule, bracket tree, and hero pick/ban stats. Switch between Group Stage and Playoffs inside the Standings and Schedule tabs. Links directly to the full tournaments page." },
