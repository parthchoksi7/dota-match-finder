        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Install as App", desc: "Add Spectate Esports to your home screen on iPhone or Android. Once installed, the site launches full-screen with no browser bar and works offline using cached data from your last visit. No app store needed. On Android, an Install button appears at the bottom of the screen on first visit; on iPhone, use Safari's Share menu and tap Add to Home Screen." },
            ].map(f => (
