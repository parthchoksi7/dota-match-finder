        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Series Grouping", desc: "Games are grouped into BO1, BO3, and BO5 series with series scores. When viewing a game, a G1/G2/G3 switcher appears in the panel header so you can jump between games without closing it." },
