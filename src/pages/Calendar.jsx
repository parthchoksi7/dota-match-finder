...
export default function Calendar() {
  ...
  function handleAllTournamentsSubscribe() {
    trackEvent('calendar_subscribe_modal_open', { source: 'all_tournaments' })
    setAllTournamentsModalOpen(true)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-white flex flex-col">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 sm:py-8 flex flex-col gap-6 flex-1 w-full">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">
            Subscribe to Dota 2 match schedules in Google Calendar, Apple Calendar, or Outlook. Add a URL once - your calendar updates automatically as matches are scheduled.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded">
          ...
          <div className="px-5 py-4 space-y-4">
            ...
            {/* All Tournaments - featured option */}
            <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded p-4">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">All Dota 2 Tournaments</p>
                  <p className="text-xs text-gray-500 dark:text-gray-500 mt-1 leading-relaxed">
                    Subscribe once to get every pro match across all active and upcoming tournaments. New events, group stages, and playoffs appear on your calendar automatically as they are scheduled - no re-subscribing needed.
                  </p>
                </div>
                <button
                  type="button"
                  onClick={handleAllTournamentsSubscribe}
                  className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-gray-200 rounded text-xs font-semibold transition-colors min-h-[44px]"
                >
            ...
            <div>
              <p className="text-xs uppercase tracking-widest text-gray-500 dark:text-gray-500 font-semibold mb-2">
                Or subscribe to a specific tournament
              </p>
              {tournamentsLoading ? (
                <div className="py-4 flex justify-center">
                  <div className="w-4 h-4 border-2 border-gray-300 dark:border-gray-700 border-t-red-500 rounded-full animate-spin" />
                  ...
                  {tournaments.map(t => (
                    <div key={t.id} className="flex items-center justify-between gap-3 py-3">
                      ...
                      <button
                        ...
                        className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded text-xs font-semibold text-gray-700 dark:text-gray-300 transition-colors min-h-[44px]"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5" aria-hidden="true">
                          <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                          <line x1="16" y1="2" x2="16" y2="6" />
      ...
      {/* All tournaments calendar modal */}
      <CalendarSubscribeModal
        isOpen={allTournamentsModalOpen}
        onClose={() => setAllTournamentsModalOpen(false)}
        url={ALL_TOURNAMENTS_URL}
        feedType="tournament"
