  ...
  async function loadDraft() {
    ...
    try {
      ...
      const players = (matchRes.players || [])
        ...
        .sort((a, b) => (LANE_ORDER[a.lane] || 6) - (LANE_ORDER[b.lane] || 6))
              ...
              .map((p, i) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-0.5">
                    ...
                    <span className="text-xs px-1.5 py-0.5 rounded bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 shrink-0 ml-1 uppercase tracking-wide font-semibold text-[10px]">
                      {p.lane}
                    </span>
                  </div>
                </div>
              ...
              .map((p, i) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-0.5">
                    ...
                    <span className="text-xs px-1.5 py-0.5 rounded bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-400 shrink-0 ml-1 uppercase tracking-wide font-semibold text-[10px]">
                      {p.lane}
                    </span>
                  </div>
                </div>
